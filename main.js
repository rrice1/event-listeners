...
// }
// //buttonThing.addEventListener('click',runThisFunction())//runs function without caring about click event
// // buttonThing.addEventListener('click',runThisFunction) //run it like this instead of above, but below might be better
// buttonThing.addEventListener('click', (event) =>{
//     runThisFunction('USERNAMESAREFUN')
// })
